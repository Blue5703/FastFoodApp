...
public class HomeFragment extends Fragment {
    ...
    private void setSpecialDetail(SpecialContainer specialContainer, Food food) {
        ...
        specialContainer.getImageView().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navigationToDetail(food.getId());
            }
        });
        specialContainer.getFoodName().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navigationToDetail(food.getId());
            }
        });
        specialContainer.getFoodPrice().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navigationToDetail(food.getId());
            }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SearchView searchView = view.findViewById(R.id.get_all_search);
